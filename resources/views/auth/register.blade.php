    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card-custom">
                <div class="card-header bg-primary-green text-white fw-bold">{{ __('Pendaftaran Donatur Baru') }}</div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6 offset-md-4 text-center">
                                <p class="text-muted small mb-0">Sudah punya akun? <a href="{{ route('login') }}">Masuk di sini</a></p>
                            </div>
                        </div>
                    </form>
                </div>
