    ...
    <div class="content-area">
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                ...
                @if($donasi->status === 'menunggu')
                    <div class="card-custom border-success" id="verifikasi" style="border-left: 5px solid #10B981 !important;">
                        <div class="card-body p-4">
                            <h5 class="fw-bold mb-3 text-theme-primary">
                                <i class="fas fa-check-circle me-2"></i> Proses Verifikasi Donasi
                            </h5>

                            <!-- Perbaikan untuk form.blade.php bagian form verifikasi -->

                            <!-- Ganti form action yang lama: -->
                            <!-- <form method="POST" action="{{ route('admin.donasi.verifikasi', $donasi) }}"> -->

                            <!-- Dengan form action yang baru: -->
                ...
                @else
                            ...
                            <div class="card-custom mb-4 bg-light">
                                <div class="card-body text-center">
                                    <p class="text-muted mb-3">Status donasi sudah **FINAL** ({{ ucwords($donasi->status) }}).
                    ...
                    <div class="col-lg-4">
                        ...
                        @if($donasi->status === 'menunggu')
                            <div class="card-custom border-warning p-3"
                    ...
                    <div class="modal-content border-0 rounded-4 shadow-lg">
                        ...
                        <div class="modal-body p-4">
                            ...
                            <div class="alert alert-warning border-warning">
                                ...
                                <p class="mb-0 small">Jika donasi ini berstatus **'Berhasil'**, jumlah yang terkumpul untuk
